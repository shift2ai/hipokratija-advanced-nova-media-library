...
export default {
  ...
  methods: {
    ...
    onSave() {
      ...
      const minWidth = this.minimumDimensions.width;
      const minHeight = this.minimumDimensions.height;

      var isValidDimensions =
        canvas.image.width >= minWidth ?? canvas.image.height >= minHeight;
      ...
      if (isValidDimensions) {
        ...
        Nova.error(
          "Minimalne dimenzije slike su: " + minWidth + "*" + minHeight
        );
      }
